...
export default function Home() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', fontFamily: 'system-ui', color: '#1a1a1a', backgroundColor: '#fdfdfd' }}>
      ...
      <aside style={{ 
        ...
        <div style={{ padding: '1.5rem', borderBottom: '1px solid #e2e8f0' }}>
          <h1 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 800, letterSpacing: '-0.02em', color: '#0f172a' }}>AGENT RUNTIME</h1>
        </div>
